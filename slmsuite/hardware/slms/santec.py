...
class Santec(SLM):
    ...
    def __init__(
        ...
        **kwargs
        ...
        if verbose:
            print(
                "Santec slm_number={} initializing... ".format(self.slm_number), end=""
            )
        ...
        try:
            ...
            if verbose:
                print(
                    "Looking for display_number={}... ".format(self.display_number),
                    end="",
                )
            Santec._parse_status(
            ...
            if names[0] != "BOE":
                ...
                raise ValueError(
                    ...
                    "Use .info() to find the correct display!".format(
                        self.display_number
                    )
                )
