...
def main():
    ...
    for _ in range(interface_list.GetSize()):
        interface = interface_list[_].TLInterface
        print(interface.InterfaceID.ToString())
        print(interface.HostAdapterName.ToString())
        # print(interface.DeviceID.ToString())
        # print(interface.DeviceModelName.ToString())
        # print(interface.DeviceSerialNumber.ToString())
